...
namespace EchoBot1.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        {
            if (_dataProvider.IsUserAlreadyEnterPersonalData(stepContext.Context.Activity.From.Id))
            {
        ...
        {
            _dataProvider.ClearAnswerStatistic(stepContext.Context.Activity.From.Id);
